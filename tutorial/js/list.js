...
let itemsArray = localStorage.getItem('options') ? JSON.parse(localStorage.getItem('options')) : []; // check if there is a items array stored
...
addButton.addEventListener("click",function(){
    ...
    localStorage.setItem('options', JSON.stringify(itemsArray)); // update items
    liMaker(data.value);
    data.value = "";
});
